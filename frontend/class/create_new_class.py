...
with col1:
    test_name = st.text_input("Class name")
    test_description = st.text_area("Class description")
...
with col3:
    if state.submit :
        ...
        <div style="background-color:#e6f4ea; padding:10px; border-radius:5px; font-size:16px; color:#2e7d32;">
            ...
            <a href="view_a_class?class_id={class1['id']}" target="_self" style="color:#2e7d32; text-decoration:none; font-weight:bold;" 
